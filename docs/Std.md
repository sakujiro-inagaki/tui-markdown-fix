...
Defined in tui-markdown-fix@0.1.0
...
### impl `Yaynu.Markdown.Ast::Block : Std::Boxed`

### impl `Yaynu.Markdown.Ast::CodeBlock : Std::Boxed`

### impl `Yaynu.Markdown.Ast::Document : Std::Boxed`

### impl `Yaynu.Markdown.Ast::Inline : Std::Boxed`

### impl `Yaynu.Markdown.Ast::ListItem : Std::Boxed`

### impl `Yaynu.Markdown.Ast::MarkdownList : Std::Boxed`

### impl `Yaynu.Markdown.Ast::Table : Std::Boxed`

### impl `Yaynu.Markdown.Render.Inline::InlineToken : Std::Boxed`

### impl `Yaynu.Markdown.Render.Options::RenderOptions : Std::Boxed`

### impl `Yaynu.Markdown.Render.Options::TableBorderStyle : Std::Boxed`

### impl `Yaynu.Markdown.Style::MarkdownStyle : Std::Boxed`

### impl `Yaynu.Markdown.Widget::MarkdownView : Std::Boxed`

### impl `Yaynu.Term.Ansi::Color16 : Std::Boxed`

### impl `Yaynu.Term.Key::Key : Std::Boxed`

### impl `Yaynu.Term.Key::KeyParseResult : Std::Boxed`

### impl `Yaynu.Term.Mode::TermMode : Std::Boxed`

### impl `Yaynu.Tui.Event::Event : Std::Boxed`

### impl `Yaynu.Tui.Event::UpdateResult s : Std::Boxed`

### impl `Yaynu.Tui.Frame::Frame : Std::Boxed`

### impl `Yaynu.Tui.Rect::Constraint : Std::Boxed`

### impl `Yaynu.Tui.Style::Color : Std::Boxed`

### impl `Yaynu.Tui.Style::Style : Std::Boxed`

### impl `Yaynu.Tui.Widget.Border::Alignment : Std::Boxed`

### impl `Yaynu.Tui.Widget.Border::Border : Std::Boxed`

### impl `Yaynu.Tui.Widget.Border::BorderType : Std::Boxed`

### impl `Yaynu.Tui.Widget.Input::Input : Std::Boxed`

### impl `Yaynu.Tui.Widget.List::List a : Std::Boxed`

### impl `Yaynu.Tui.Widget.Paragraph::Paragraph : Std::Boxed`

### impl `Yaynu.Tui.Widget.Paragraph::WrapMode : Std::Boxed`

### impl `Yaynu.Tui.Widget.Progress::Progress : Std::Boxed`

### impl `Yaynu.Tui.Widget.Spinner::Spinner : Std::Boxed`

### impl `Yaynu.Tui.Widget.Tabs::Tabs : Std::Boxed`

### impl `Yaynu.Tui.Width.Table::EawClass : Std::Boxed`

### impl `Yaynu.Tui.Width.Table::EmojiProp : Std::Boxed`